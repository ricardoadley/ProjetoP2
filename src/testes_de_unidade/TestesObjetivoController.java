...
class TestesObjetivoController {
	...
	void testCadastraObjetivoValorInvalidoViabilidade() {
		assertThrows(NumberFormatException.class,
				() -> controlador.cadastraObjetivo("GERAL", "descreve o erro pai", "4", "L"));
	}
	...
	void testCadastraObjetivoValorInvalidoTipo() {
		assertThrows(IllegalArgumentException.class,
				() -> controlador.cadastraObjetivo("geralzao", "descrito", "3", "4"));
	}
	...
	void testCadastraObjetivoViabilidadeMaiorQueCinco() {
		assertThrows(IllegalArgumentException.class,
				() -> controlador.cadastraObjetivo("GERAL", "descreve todo", "3", "7"));
	}

	@Test
	void testCadastraObjetivoViabilidadeMenorQueCinco() {
		assertThrows(IllegalArgumentException.class,
				() -> controlador.cadastraObjetivo("GERAL", "descrever aqui", "5", "0"));
	}
	...
	void testProcuraPalavraPerfeito() {
		controlador.cadastraObjetivo("GERAL", "assistir o anime naruto", "5", "3");
		controlador.cadastraObjetivo("ESPECIFICO", "procurar manga do filho de naruto na blackfriday", "3", "4");
		ArrayList<String> retorno = new ArrayList<String>();
		retorno.add("O2: procurar manga do filho de naruto na blackfriday");
		retorno.add("O1: assistir o anime naruto");
