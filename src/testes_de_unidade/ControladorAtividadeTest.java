...
class ControladorAtividadeTest {
	...
	void testaCadastroAtividade() {
		...
		assertEquals("A1", controlAtividadeTest.cadastraAtividade("Ajudar pessoas com deficiencia", "BAIXO", "Risco diferenciado"));
		assertEquals("A2", controlAtividadeTest.cadastraAtividade("Fiscalizar crimes", "ALTO", "Risco alto"));
		assertEquals("A3", controlAtividadeTest.cadastraAtividade("Realizar doacoes", "MEDIO", "Risco bastante critico"));
	}
	
	@Test
	void testaCadastroAtividadeRiscoInvalido() {
		
		assertThrows(IllegalArgumentException.class, () -> controlAtividadeTest.cadastraAtividade("Ajudar pessoas com deficiencia", "MUITO BAIXO", "Risco diferenciado"));
		assertThrows(IllegalArgumentException.class, () -> controlAtividadeTest.cadastraAtividade("Ajudar pessoas com deficiencia", "POUCO ALTO", "Risco diferenciado"));
		assertThrows(IllegalArgumentException.class, () -> controlAtividadeTest.cadastraAtividade("Ajudar pessoas com deficiencia", "ALTISSIMO", "Risco diferenciado"));
	...
	void testaExibeAtividade() {
		...
		assertEquals(controlAtividadeTest.exibeAtividade("A1"), "Ajudar pessoas (ALTO - Falta de empatia humana)"
				+ " | PENDENTE - Fazer cafe | PENDENTE - Cameras");
	...
	void testCadastraResultadoAtividadeNaoEncontrada() {
		controlAtividadeTest.cadastraAtividade("Atividade de teste","MEDIO","aqui descreve");
		assertThrows(IllegalArgumentException.class, () -> controlAtividadeTest.cadastraResultado("A1456789","voce que lute"));
	}
	@Test
	...
	void testListaResultadosComSucesso() {
		...
		assertEquals("pode ser um resultado duvidoso | aqui um segundo resultado",controlAtividadeTest.listaResultados("A1"));
	}
	@Test
