...
public class PesquisaController {
	 ...
	 * v�rios objetivos, entretanto, cada objetivo s� pode estar associado a uma
	 * �nica pesquisa.
	 * 
	 ...
	 * sucesso ou nao da operacao. Uma pesquisa pode estar associada a um �nico
	 * problema. Mas o mesmo problema pode estar associado a v�rias pesquisas.
	 * 
	 * @param idPesquisa o identificador unico da pesquisa
	...
	/**
	 * Retira a associa��o entre um Problema e uma Pesquisa
	 * 
	 * @param idPesquisa o identificador unico da Pesquisa
	 * @param idProblema o identificador unico do Problema
	 * @return return a String correspondente ao sucesso ou nao da operacao
	...
	/**
	 * Executa a gravacao da situacao atual do mapa de dados da entidade pesquisa no
	 * arquivo
	 */
	public void salvar() {
